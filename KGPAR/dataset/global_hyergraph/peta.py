...
def unified_clip_feature_extraction(
   ...
   'male'
    ...
    for i, (img_name, label) in enumerate(tqdm(zip(image_names, labels), total=len(image_names), desc="收集属性图像")):
...
if __name__ == '__main__':
    pkl_path = "/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/petapad.pkl"
    entity_text_path = '/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/KGPAR/dataset/hy/peta.txt'
    output_path = '/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/KGPAR/dataset/hy/peta_unified_clip_features_10.pt'
