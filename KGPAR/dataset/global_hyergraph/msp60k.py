...
def unified_clip_feature_extraction(
    ...
    if len(text_lines) != 57:
        raise ValueError(f"文本行数为 {len(text_lines)}")

    attribute_keys = [
        'Female', 'Child', 'Adult', 'Elderly', 'Fat', 'Normal', 'Thin',
       'Bald', 'Long hair', 'Black hair', 'Hat', 'Glasses', 'Mask',
       'Helmet', 'Scarf', 'Gloves', 'Front', 'Back', 'Side',
       'Short sleeves', 'Long sleeves', 'Shirt', 'Jacket', 'Suit', 'Vest',
       'Cotton-padded coat', 'Coat', 'Graduation gown', 'Chef uniform',
       'Trousers', 'Shorts', 'Jeans', 'Long skirt', 'Short skirt',
       'Dress', 'Leather shoes', 'Casual shoes', 'Boots', 'Sandals',
       'Other shoes', 'Backpack', 'Shoulder bag', 'Handbag',
       'Plastic bag', 'Paper bag', 'Suitcase', 'Others',
       'Making a phone call', 'Smoking', 'Hands behind back',
       'Arms crossed', 'Walking', 'Running', 'Standing',
       'Riding a bicycle', 'Riding an scooter', 'Riding a skateboard'
    ]
...
if __name__ == "__main__":
    pkl_path = "/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/MSP60K/SUBMIT/dataset_random.pkl"
    entity_text_path = '/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/KGPAR/dataset/hy/msp60k.txt'
    output_path = '/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/KGPAR/dataset/hy/msp60k_unified_clip_features_10.pt'
