...
def get_label_embeds(labels):
    model = SentenceTransformer('/wdata/Code/wushujuan/VTB/VTB/all-mpnet-base-v2')
...
if __name__ == "__main__":
    save_dir = '/wdata/Dataset/graph/peta/'
    new_split_path = '/wdata/Dataset/graph/peta/dataset_zs_run0.pkl'
