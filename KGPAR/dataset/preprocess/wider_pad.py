...
def generate_data_description(save_dir):
    ...
    dataset.root = os.path.join(save_dir, 'WIDER')
    ...
    trainval_name_file=open("/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/wushujuan/wider_mat/trainval_name.txt",'r',encoding='utf8').readlines()
    for name in trainval_name_file :
        curLine=name.strip('\n')
        trainval_name.append(curLine)    
        
    test_name_file=open("/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/wushujuan/wider_mat/test_name.txt",'r',encoding='utf8').readlines()
    for name in test_name_file :
        curLine=name.strip('\n')
        test_name.append(curLine)        
    
    trainval_gt_file=open("/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/wushujuan/wider_mat/trainval_gt_label.txt",'r',encoding='utf8').readlines()
    ...
    test_gt_file=open("/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/wushujuan/wider_mat/test_gt_label.txt",'r',encoding='utf8').readlines()
    ...
    attr_file=open("/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb61/DATA/wushujuan/wider_mat/attr_name.txt",'r',encoding='utf8')
    ...
    with open(os.path.join(save_dir, 'widerpad.pkl'), 'wb+') as f:
