...
class TransformerClassifier(nn.Module):
    def __init__(self, clip_model, attr_num, attributes, dim=768, pretrain_path='/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c0/DATA/kongweizhe/PARMamba/VTB-main/checkpoints/jx_vit_base_p16_224-80ecf9dd.pth'):
        super().__init__()
        super().__init__()
        ...
        self.attack_noisy = torch.nn.Parameter(torch.zeros((3,args.height,args.width)))


        self.defense_filter = nn.Conv2d(in_channels=3, out_channels=3, kernel_size=3, stride=1, padding='same')
