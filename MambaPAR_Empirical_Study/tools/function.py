...
def get_pkl_rootpath(dataset):
    if dataset.endswith("zs"):
        root = os.path.join("/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c0/DATA/kongweizhe/PARMamba/VTB-main/dataset", f"{dataset.replace('zs','')}")
        data_path = os.path.join(root, 'dataset_zs.pkl')
    else:
        root = os.path.join("/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c0/DATA/kongweizhe/PARMamba/VTB-main/dataset", f"{dataset}")
