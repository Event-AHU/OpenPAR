...
class HybridClassifier(nn.Module):
    ...
    def forward_once(self,i,x_vit,x_vim,residual = None):
        ...
        x_vim_1,residual_1 = self.vim_layers[2*i](x_vim,residual)
        x_vim_2,residual = self.vim_layers[2*i+1](x_vim_1,residual_1)

        x_vim = self.up_projs[i](x_vim_2)

        x_vit = x_vit + x_vim
        x_vim = self.down_projs[i](x_vit)
        # breakpoint()
