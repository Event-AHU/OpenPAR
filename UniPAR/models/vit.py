    ...
    def load_param(self, model_path):
        ...
        for k, v in param_dict.items():
            ...
            if k.startswith('vit.'): 
                k = k[4:]
                # print(k)
            if 'head' in k or 'dist' in k or 'vis' in k or 'word' in k or 'tex' in k or 'encoder' in k or 'decoder' in k:
                continue
...
def vit_large(img_size=(256, 128), stride_size=16, drop_rate=0.0, attn_drop_rate=0.0, drop_path_rate=0.1, **kwargs):
    model = ViT(
